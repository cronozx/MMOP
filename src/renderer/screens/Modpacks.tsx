                    ...
                    {modpacks.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {modpacks.map((modpack, index) => {
                                const contributersCount = Object.keys(modpack.contributers || {}).filter(userId => modpack.contributers[userId] === true).length;
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {(contributersCount || 0) > 0 && (
                                            <div className="mt-2 flex items-center space-x-2">
                                                <span className="text-gray-600 text-xs">
                                                    +{contributersCount || 0} {contributersCount === 1 ? 'contributor' : 'contributors'}
                                                </span>
                                            </div>
                                        )}
                                    </div>
